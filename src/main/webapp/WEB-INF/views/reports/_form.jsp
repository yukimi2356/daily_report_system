...
<label for="${AttributeConst.REP_ATTENDED_AT.getValue()}">出勤</label><br />
<input type="text" name="${AttributeConst.REP_ATTENDED_AT.getValue()}" value="${report.attendedAt}" />
<br /><br />

<label for="${AttributeConst.REP_LEAVED_AT.getValue()}">退勤</label><br />
<input type="text" name="${AttributeConst.REP_LEAVED_AT.getValue()}" value="${report.leavedAt}" />
<br /><br />
