...
;
    ...
    String Q_EMP_COUNT = ENTITY_EMP + "/getByCodeAndPass";
    String Q_EMP_GET_BY_CODE_AND_PASS_DEF = "SELECT e FROM Employee AS e WHERE e.deleteFlag = 0 AND e.code = :" + JPQL_PARM_CODE + "AND e.password = :" + JPQL_PARM_PASSWORD;
    String Q_EMP_COUNT_RESISTERD_BY_CODE = ENTITY_EMP + ".countRegisteredByCode";
    String Q_EMP_COUNT_RESISTERD_BY_CODE_DEF = "SELECT COUNT(e) FROM Employee AS WHERE e.code = :" + JPQL_PARM_CODE;
